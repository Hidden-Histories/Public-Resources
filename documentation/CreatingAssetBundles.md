...
- We will add another template soon that can generate both, for people who have Macs and want to try making both asset bundles. Note that if you do not have both iOS and Android devices, you will have to team up with someone to test the devices you do not own.
