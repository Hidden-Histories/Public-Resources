...
* **Relative location**: The location of the POI relative to your body. Your body's position is at 0,0,0 with y=0 being your eye level. This is a comma separated list of the x =east-west, y = up-down, z = north-south values. **These values override the Lat/Lon values and the Absolute altitude and Relative altitude values.** Note however that although the distance from your body is stable, and the distance and orientation of POIs in a layer ~with respect to each other* are stable, the orientation of all the POIs with respect to the cardinal directions is *not* stable. They will rotate around you so that for instance a POI you place at 0,0,5 which should be 5m due north of you, can be anywhere in a circle of 5 meters radius around you.
